...
class IndexControllerTest {
    ...
    void initTest() {
        this.indexController = new IndexController(
                categoriesService, interviewsService, authService, notificationService, profileService
        );
    }
    ...
    void whenGetIndexPageExpectModelAttributeThenOk() throws JsonProcessingException {
        ...
        Set<ProfileDTO> setProfiles = Set.of(
                new ProfileDTO(1, "1", "", 1, calendar, calendar),
                new ProfileDTO(2, "2", "", 2, calendar, calendar)
        );
        ...
        when(profileService.getByInterviews(listInterviews)).thenReturn(setProfiles);
        ...
        assertThat(actualProfiles).usingRecursiveComparison().isEqualTo(setProfiles);
    }
}